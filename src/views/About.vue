<template>
  <v-container class="d-flex flex-column align-center align-md-end">
    ...
    >
      ...
      <v-card-text>
        <p>
          Hello, and welcome to my blog! I'm Hannah, and this is where I write about the stuff I do. Currently, I live in Fort Mill, SC with my three cats. I like to keep myself busy by keeping up with a multitude of hobbies, which include cooking, gardening, needle arts, coding, reading, woodworking, and learning Japanese.
        </p>
        <p>
          Find me on:
          <v-list dense >
