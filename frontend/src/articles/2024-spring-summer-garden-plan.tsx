    ...
    return (
        <ArticleContentContainer>
            ...
            <Section>
                ...
                <p>
                    Below is a list of the varieties I will be using. I ordered my seeds from <a href="https://burpee.com" target="_blank">Burpee</a>.
                    <ul>
            ...
            <Section>
                ...
                <ul>
                    <li><a href="https://a.co/d/9cGkru7" target="_blank">Companion Planting: Organic Gardening Tips and Tricks for Healthier, Happier Plants</a></li>
                </ul>
            </Section>
        </ArticleContentContainer>
    )
