...
const HomeIsWhereTheCakeIs: React.FunctionComponent = (): ReactElement => {
    return (
        <ArticleContentContainer>
            <Section>
                <p>
                    When I came across <a href="https://www.everythingcrossstitch.com/where-the-cake-is-mrp-p94406.aspx?k2=e1" target="_blank">this "home is where the cake is" design</a>, I knew I had to make it for my cake-obsessed boyfriend. 
                </p>
            </Section>
            <Section>
