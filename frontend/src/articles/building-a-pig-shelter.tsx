...
const Garden2023Plan: React.FunctionComponent = (): ReactElement => {
    return (
        <ArticleContentContainer>
            ...
            <Section>
                <FullSizeImage src="https://blog-images.poppyland.dev/pig_shelter_2.png" />
                <p>The finished base</p>
            </Section>
            <Section>
                <FullSizeImage src="https://blog-images.poppyland.dev/pig_shelter_4.png" />
                <p>The frame in progress</p>
            </Section>
            <Section>
                <FullSizeImage src="https://blog-images.poppyland.dev/pig_shelter_5.png" />
